		...
		<h1 style="margin: 10px auto; text-align: center; font-weight:900; font-family: roboto;">Thông tin đặt hàng của bạn </h1>
		...
		<div style="width:100%;height:auto">
				<table style="width:100%; height:auto; border-collapse: collapse; border: 1px solid;">
					...
					@foreach($shopping as $key=>$cart)
						<tr style="border: 1px solid; padding: 8px;">
							...
							<td style="border: 1px solid; padding: 8px;">
								<h4>{{number_format($cart['price']*$cart['qty'])}}</h4>
							</td>
						...
						<tr>
							...
							<td colspan="2">
								<table class="table table-condensed total-result">
									...
									<tr>
										<td>Tổng tiền</td>
										<td><h1>{{number_format($total_price)}}</h1></td>
									</tr>
								</table>
							</td>
						</tr>
			...
			<div><a 
				style="display: inline-block;width:200px; height:35px; padding: 10px 25px; background: green;color:#fff; font-weight:bold; text-align: center;margin-top:20px; font-family: roboto; font-size:16px;" 
				href="{{ route('cart.assert_order',
						[
						'id'=>$donhang->id,
