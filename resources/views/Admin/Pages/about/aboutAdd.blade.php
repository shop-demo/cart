        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('admin.aboutAdd_post') }}" method="POST">
                  @csrf
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" name="title" value="{{old('title')}}" placeholder="Nhập nội dung tiêu đề">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-10 d-flex p-3 ">
                    <input class="form-control" type="text" name="avatar" id="image" style="width: 70%;height:auto;" value="{{ old('avater')}}" placeholder="Chọn ảnh">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px" name="content" placeholder="Nhập nội dung">{{ old('content')}}</textarea>
                    @error('content')
                    <span class="text-danger">{{$message}}</span>
                    @enderror('content')
                  </div>
